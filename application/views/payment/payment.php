...
<div class="pay1">
	<div class="pa2">
    	<ul class="list2 box gr">
            ...
            <a href="javascript:openPop('pop_payment','500','550','yes')" class="btn btn1">결제항목 생성하기</a>
        </ul>
    </div>
    ...
    <table class="td2 td_c">
        <thead>
            <tr>
              <td><input type="checkbox" name="toggle_check" value="1" onclick="toggle_checkbox(this.form['no[]'])"></td>
                <td>항목</td>
                <td>유효기간</td>
                <td>청구액</td>
            </tr>
        ...
        <tbody>
            ...
            <tr>
              ...
              <td><span class="bl_date"><?=$value['start_date']?>~ <?=$value['end_date']?></span></td>
              <td><span class="bl_coun"><?=number_format($value['real_price'])?>원</span></td>
            </tr>
            <?endforeach;?>
            <?else:?>
            <tr><td colspan="3">결제할 항목이 없습니다</td></tr>
            <?endif;?>
        </tbody>
    </table>
