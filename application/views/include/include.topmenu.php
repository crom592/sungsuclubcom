<div id="topmenu_w">
    <div id="spot">
        ...
        <ul id="spot_r">
            ...
            <?else:?>
            <!--Before Login-->
            <li><a href="/member/login" onclick="return gaClick('GA로그인', '로그인버튼클릭','로그인_로그인버튼클릭')">로그인</a></li>
            <li><a href="/member/join" onclick="return gaClick('GA회원가입', '회원가입버튼클릭','회원가입_회원가입버튼클릭')">회원가입</a></li>
    ...
    <div id="topmenu">
        <div class="t_bigmenu">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                var companyLink = document.querySelector('a[href="/company/company01.php"]');
                if(companyLink) {
                    companyLink.parentElement.addEventListener('mouseenter', function() {
                        document.getElementById('submenu').style.display = 'none';
                    });
                    companyLink.parentElement.addEventListener('mouseleave', function() {
		...
		<div id="submenu">
			<div class="t_submenu">
                ...
                <ul class="sub_press">
                    <li><a href="/press/press01.php">시사오늘 2008.08.27</a></li>
                    <li><a href="/press/press02.php">시사오늘 2011.08.27</a></li>
                </ul>
                <ul class="sub_option">
