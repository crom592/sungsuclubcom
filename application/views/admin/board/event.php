...
<div class="board_list_wrap">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="bl_subject"><a href="view?no=<?=$value['no']?>&code=event"><?=$value['title']?></a></td>
    ...
    <ul class="pagenation">
        <?php  if (count($list) > 0) { ?>
                <?php echo pagingView('/adm/board/event', $sPage, $_GET['page'], $ePage, $pageNum, $param)?>
            <?php } ?>
    ...
    <div class="btn_wrap"> 
        ...
        <a href="write?no=&code=event" class="btn btn1 rr">글쓰기</a> 
    </div>
</div>
