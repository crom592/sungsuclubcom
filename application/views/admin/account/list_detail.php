      ...
      <tr>
        ...
        <ul class="etc">
            ...
            <select class="ipw ipw1">
                ...
                <option value="3">신용카드 결제(학회)</option>
                <option value="4">현금</option>
                <option value="5">사면</option>
                <option value="6">자동 결제</option>
                <option value="7">신용카드 결제(현장)</option>
  ...
  <ul class="list_top">
    ...
    <tbody>
        <tr>
          ...
          <td class="bl_date">2021-11-11<br />(2021-11-11)</td>
