...
$SubNum="7";
 ?>
<body class="ad_in">
<form name="sym_frm" id="sym_frm" method="post" action="/ajax/symposium/save_accomodation">
...
<div class="board_write_wrap sym_w">
    ...
    <tbody>
        <tr>
            <th>숙박</th>
            <td><textarea class="ipw ipw_tt" name="accomodation"><?=$sym['accomodation']?></textarea></td>
        </tr>
    </tbody>
    </table>
    <!--//Write-->    
