...
<div class="board_list_wrap">
  ...
  <form>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="bl_subject"><a href="<?=strip_tags($value['link_url'])?>" target="_blank"><?=$value['link_url']?></a></td>
    ...
    <ul class="pagenation">
        <?php  if (count($list) > 0) { ?>
                <?php echo pagingView('/adm/utube/list', $sPage, $_GET['page'], $ePage, $pageNum, $param)?>
            <?php } ?>
  ...
  <div class="btn_wrap"> 
        ...
        <a href="write" class="btn btn1 rr">동영상 등록</a>
  </div>
</div>
