...
<base target="detail">
    ...
    <div id="leftm">
        ...
        <div class="ss_menu" id="smenu30">
            <ul>
                <li><a href="/adm/board/list?code=huntaek" target="detail">시황 및 매매분석</a></li>
                <li><a href="/adm/board/list?code=tomorrow" target="detail">복기의 창</a></li>
            </ul>
        </div>
        ...
        <div class="ss_menu" id="smenu20">
            <ul>
                <li><a href="/adm/board/list?code=communication" target="detail">소통의 장</a></li>
                <li><a href="/adm/board/list?code=notice" target="detail">공지사항</a></li>
            </ul>
        </div>  
        <div class="s_menu" force="40"> <a>선물옵션분석표</a> </div>
        <div class="ss_menu" id="smenu40">
            <ul>
                <li><a href="/adm/board/list?code=future" target="detail">선물옵션분석표</a></li>
        ...
        <div class="ss_menu" id="smenu50">
            <ul>
                <li><a href="/adm/board/list?code=review" target="detail">교육생후기</a></li>
                <li><a href="/adm/board/list?code=trading" target="detail">통합매매일지</a></li>
                <li><a href="/adm/board/list?code=corner" target="detail">진서리코너</a></li>
                <li><a href="/adm/board/list?code=diary" target="detail">운영Diary</a></li>
            </ul>
        </div> 
        ...
        <div class="ss_menu" id="smenu60">
            <ul>
                <li><a href="/adm/utube/list" target="detail">유투브관리</a></li>
                <li><a href="/adm/banner/list" target="detail">배너관리</a></li>
                <!-- <li><a href="/adm/popup/list" target="detail">팝업관리</a></li> -->
