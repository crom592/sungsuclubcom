...
<div class="board_write_wrap vod_write">
	<!--Write-->
    <div class="input_tit">팝업 등록<u class="tt_r">팝업에 표시할 이미지나 내용을 입력하세요</u></div>
          ...
          <td>
            <?
                ...
                <?  $idx++;
                 ...
                 endforeach;?>
            <input type="file" class="ipw" name="up_file1"/><span class="file_btn"> <span class="tt">600 X 800 pixel 로 업로드해주세요</span>
            </td>
        </tr>
    ...
    <div class="btn_wrap"> 
        <a href="javascript:form_submit()" class="btn btn1 cc">팝업 등록</a>
    </div>
