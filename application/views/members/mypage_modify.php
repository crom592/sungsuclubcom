...
<div class="join_wrap">
  <div class="members_tit"> 
    <i class="i-user-plus-o"></i>회원정보 <b>수정</b> <u>해당되는 정보를 입력하여 주시기 바랍니다. <span class="tt_r">*</span> 는 필수입력 사항입니다.</u> 
  </div>
  <div class="break_w">
      <a href="/member/mypage/withdrawal" class="break_btn btn1">회원탈퇴하기</a>
  </div>
  <!--Join input-->
  <div class="pa2">
    <div class="input_tit">회원 기본정보 수정 <u>필수입력사항</u></div>
    <table class="td1 mb50">
      <tbody>
        ...
        ?>
        <th><span class="tt_r">*</span> 휴대폰번호</th>
        ...
        <tr>
          ...
          <td><input class="ipw ipw3" type="text" maxlength="4" name="user_phone21" id="user_phone21" value="<?=$user_phone2_arr[0]?>"> -
            ...
            <input class="ipw ipw3" type="text" maxlength="4" name="user_phone23" id="user_phone23" value="<?=$user_phone2_arr[0]?>"> <span class="tt">지역번호를 반드시 포함할 것</span></td>
        </tr>
        <?
