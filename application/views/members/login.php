...
<input type="hidden" name="gourl" value="<?=$_REQUEST['gourl']?>">
<div class="login_wrap">
	<div class="members_tit"><i class="i-user-plus-o"></i></i>회원 <b>로그인</b><u>회원의 아이디와 비밀번호를 입력하신 후, 로그인 버튼을 클릭해 주세요.</u></div>
	<ul class="login_input">
    	<li><input type="text" title="아이디" placeholder="아이디" class="ipw" name="user_id" /></li>
        <li><input type="password" title="비밀번호" placeholder="비밀번호" class="ipw" name="user_pw"/></li>
    ...
    <ul class="login_txt">
    	<li><i class="i-users-plus"></i> <p>회원가입으로 다양한 혜택을 누리실 수 있습니다.</p> <a href="/member/join" class="btn btn2">회원가입</a></li>
