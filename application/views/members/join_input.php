...
<div class="join_wrap">
  <div class="members_tit"> 
    <i class="i-user-plus-o"></i>회원정보 <b>입력</b> <u>해당되는 정보를 입력하여 주시기 바랍니다. <span class="tt_r">*</span> 는 필수입력 사항입니다.</u> 
  </div>
      ...
      <tbody>
        <tr>
          ...
          <td><input  class="ipw ipw1" type="text" maxlength="12" name="user_id" id="user_id"/>  
             <span class="tt">4~12자의 영문과 숫자의 조합</span><span id="id_check_view"></span> 
           </td>
        </tr>
        <tr>
