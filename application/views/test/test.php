...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var buyername1 = document.ini.buyername1;
            var company = document.ini.company;
            var buyeremail = document.ini.buyeremail;
            var buyerphone = document.ini.buyerphone;
            var buyertel = document.ini.buyertel;            
            ...
            var result = document.ini.buyername1;
            var company = document.ini.company;
            var buyeremail = document.ini.buyeremail;
            var buyerphone = document.ini.buyerphone;
            var buyertel = document.ini.buyertel;    

            //document.ini.merchantData.value = 'buyername1=' + document.ini.buyername1.value + "&company=" + document.ini.company.value +"&buyeremail=" + document.ini.buyeremail.value +"&buyerphone=" + document.ini.buyerphone.value +"&buyertel=" + document.ini.buyertel.value;
                                        ...
                                        <td style="text-align:left;">
                                            <form id="ini" name="ini" method="POST">
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><b>buyername</b> :
                                                    <br/><input  style="width:100%;" name="buyername1" value="홍길동" >
                                                    <br/><input  style="width:100%;" name="company" value="성균관" >

                                                    <br/><b>buyertel</b> :
                                                    <br/><input  style="width:100%;" name="buyertel" value="02-1234-5678" >

                                                    <br/><b>buyeremail</b> :
                                                    <br/><input  style="width:100%;" name="buyeremail" value="test@inicis.com" >

                                                    <br/><b>buyerphone</b> :
                                                    <br/><input  style="width:100%;" name="buyerphone" value="010-1234-5678" >
                                                    ...
                                                    <br/><b>returnUrl</b> :
                                                    <br/><input  style="width:100%;" name="returnUrl" value="https://infoeyeplus.cafe24.com/iniPay/INIStdPaySample/INIStdPayReturn.php" >
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input  style="width:100%;" name="gopaymethod" value="Vbank" >
                                                    <br/><br/>
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/>인증결과 리턴시 함께 전달됨
                                                    <br/><input  style="width:100%;" name="merchantData" value="182,188" >
                                                </div>
                                            </form>
                                        </td>
                                    </tr>
