...
class VodFile_m extends CI_Model
{
    ...
    public function saveFile($finalFilesData=[], $owner_no, $oldFileArray=[])
    {
        ...
        foreach ($finalFilesData as $index => $value) {
            ...
            $this->db->delete('tbl_vod_file', array('fk_board_no'=>$owner_no, 'no' => $index));
            ...
            $this->db->insert('tbl_vod_file', $insertData);
    ...
    public function deleteFile($no)
    {
        ...
        $this->db->delete('tbl_vod_file', array('fk_board_no'=>$no));
