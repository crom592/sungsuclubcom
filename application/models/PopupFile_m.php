...
class PopupFile_m extends CI_Model
{
    ...
    public function getFile($where="")
    {
        ...
        $rs = $this->db->get("tbl_popup_files");
    ...
    public function saveFile($finalFilesData=[], $owner_no, $oldFileArray=[])
    {
        ...
        foreach ($finalFilesData as $index => $value) {
            ...
            $this->db->delete('tbl_popup_files', array('fk_popup_no'=>$owner_no, 'no' => $index));

            $insertData = array(
                'file_name' => $value['client_name']
                ,'sys_file_name' => $value['file_name']
                ,'fk_popup_no' => $owner_no
            ...
            $this->db->insert('tbl_popup_files', $insertData);
