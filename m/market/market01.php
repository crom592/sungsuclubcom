...
<div class="board_list_wrap">
	...
	<div class="board_list">
    	...
    	<ul class="bl_list notice" onclick="location.href='market01_view.php';">
        	<li class="bl_num"><i class="i-notice"></i></li>
            <li class="bl_subject">
            <span class="market_icon"><img src="/images/market/bi_01.png" /> <img src="/images/market/bi_02.png" /></span>
            게시판의 공지사항입니다. </li>
            <li class="bl_info">
            	<span class="bl_name"><i class="i-user"></i>임훈택 실장</span>
                <span class="bl_date">2021.12.12.</span>
                <span class="bl_coun"><i class="i-eye"></i>100</span>
            </li>
        </ul>
	    <ul class="bl_list" onclick="location.href='market01_view.php';">
        	<li class="bl_num">2</li>
            <li class="bl_subject">
            <span class="market_icon"><img src="/images/market/bi_03.png" /></span>
            게시판의 제목이 들어갑니다. 새로운 게시물은 뉴아이콘이 붙습니다.<i class="new i-new"></i> </li>
            <li class="bl_info">
            	<span class="bl_name"><i class="i-user"></i>임훈택 실장</span>
                <span class="bl_date">2021.12.12.</span>
                <span class="bl_coun"><i class="i-eye"></i>100</span>
        ...
        <ul class="bl_list" onclick="location.href='market01_view.php';">
        	<li class="bl_num">2</li>
            <li class="bl_subject">
            <span class="market_icon"><img src="/images/market/bi_05.png" /></span>
            코멘트의 갯수가 표시됩니다. <span class="comment">[4]</span></li>
            <li class="bl_info">
            	<span class="bl_name"><i class="i-user"></i>임훈택 실장</span>
                <span class="bl_date">2021.12.12.</span>
                <span class="bl_coun"><i class="i-eye"></i>100</span>
