...
<div class="board_list_wrap">
	...
	<div class="board_list">
    	...
    	<ul class="bl_list notice" onclick="location.href='diary01_view.php';">
        	<li class="bl_num"><i class="i-notice"></i></li>
            <li class="bl_subject">게시판의 공지사항입니다. </li>
            <li class="bl_info">
            	<span class="bl_name"><i class="i-user"></i>홍길동</span>
                <span class="bl_date">2021.12.12.</span>
                <span class="bl_coun"><i class="i-eye"></i>100</span>
            </li>
        </ul>
	    <ul class="bl_list" onclick="location.href='diary01_view.php';">
    ...
    <div class="btn_wrap"> 
        <a href="diary01_write.php" class="btn btn1">글쓰기</a> 
    </div>
</div>
